...
public class CIntpCPA extends AbstractCPA implements ConfigurableProgramAnalysis, StatisticsProvider {
    ...
    public CIntpCPA(Configuration pConfig, LogManager pLogger, ShutdownNotifier pShutdownNotifier, CFA pCfa) {
        super("sep", "sep", new CIntpTransferRelation());
        pLogger.log(Level.INFO, "CIntpCPA is used for PredicateCPA, please place CIntpCPA before the PredicateCPA!");
    ...
    public PrecisionAdjustment getPrecisionAdjustment() {
        try {
            ...
            this.logger.log(Level.SEVERE, "Failed to get the precision adjustment operator: " + e.getMessage());
            e.printStackTrace();
        }
        return null;
    }
    ...
    public <T extends ConfigurableProgramAnalysis> T retriveCPA(final ConfigurableProgramAnalysis pCPA, Class<T> pClass) throws InvalidConfigurationException {
