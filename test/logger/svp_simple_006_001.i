...
# 5 "svp_simple_006_001.c" 2
# 119 "svp_simple_006_001.c"

# 119 "svp_simple_006_001.c"
void task_compute();
void task_RR_Wheel_isr();
void task_FL_Wheel_isr();
void task_FR_Wheel_isr();
...
# 710 "svp_simple_006_001.c" 3 4
   _Bool 
# 710 "svp_simple_006_001.c"
        rtb_RelationalOperator;
    int rtb_vms;
    int u;
    rtb_vms = 10 + brake_acc_nodiv_ctrl_B_local_RT4;
...
# 736 "svp_simple_006_001.c"
    int tmp0 = 10;
    int tmp1 = 10 + rtb_vms;
    if (tmp0 > tmp1) {
        rtb_RelationalOperator = 
# 739 "svp_simple_006_001.c" 3 4
                                1
# 739 "svp_simple_006_001.c"
                                    ;
    } else {
        rtb_RelationalOperator = 
# 741 "svp_simple_006_001.c" 3 4
                                0
# 741 "svp_simple_006_001.c"
                                     ;
    }
