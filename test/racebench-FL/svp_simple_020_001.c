...
volatile int svp_simple_020_001_global_final;
...
void svp_simple_020_001_main() {
  ...
  svp_simple_020_001_local_var1 = __VERIFIER_nondet_int();
  svp_simple_020_001_local_var2 = __VERIFIER_nondet_int();
...
void svp_simple_020_001_isr_2() {
  ...
  svp_simple_020_001_global_final = 3;
  svp_simple_020_001_global_flag = 1;
  enable_isr(3);
}

void svp_simple_020_001_isr_3() {
...
void svp_simple_020_001_isr_1() {
  int tmp = svp_simple_020_001_global_final+1;
  svp_simple_020_001_global_final = tmp;
}
//bug点:
